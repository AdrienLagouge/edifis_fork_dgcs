...
labels24 <- c(
  "Salaire brut (PR)",
  "Temps de travail en % du temps plein Smic brut (PR)",
  "Salaire brut en % du Smic brut temps plein (PR)",
  "ARE nette (PR)",
  "Salaire de référence net pour l'ARE (N-1 et N-2) (PR)",
  "Cotisations sociales employeurs avant all. généraux (PR)",
  "Allègements généraux de cotisations (PR)",
  "Cotisations sociales salariés (PR)",
  "CSG déductible sur les salaires (PR)",
  "CSG non déductible / CRDS (PR)",
  "Total des prélèvements sociaux",
  "Salaire superbrut (PR)",
  "Salaire net (PR)",
  "Temps de travail en % du temps plein Smic net (PR)",
  "Salaire net en % du Smic net temps plein (PR)",
  "Salaire déclaré (PR)",
  "Salaire net du conjoint",
  "ARE nette du conjoint",
  "Autres revenus imposables du ménage",
  "Total des revenus primaires du ménage",
  "Base ressources du ménage pour l'ASS (revenu imposable N-1 avant abattements)",
  "Revenu imposable du ménage (N-1)",
  "Revenu imposable du ménage (N-2)",
  "Revenu imposable du ménage (N-2) avec abatt. 30% rev. act. N-2 pour les bénéficiaires ARE",
  "ASS - Montant (conjoint)",
  "ASS - Prime de Noël (conjoint)",
  "AL - Base ressources",
  "AL - Montant",
  "Allocations familiales - Montant",
  "Plafond CF non majoré",
  "Plafond CF majoré",
  "Complément familial - Montant",
  "Allocation soutien familial - Montant",
  "Plafond AB taux partiel",
  "Plafond AB taux plein",
  "AB (Paje) - Montant",
  "AAH - Base ressources (PR)",
  "AAH - Montant (PR)",
  "AAH - Maj. vie autonome (PR)",
  "AAH - Base ressources (conjoint)",
  "AAH - Montant (conjoint)",
  "AAH - Maj. vie autonome (conjoint)",
  "AAH - Montant",
  "Max (AAH,ASS) du conjoint",
  "RSA - Forfait logement",
  "RSA - Base ressources",
  "RSA - Montant",
  "RSA Prime de Noël - Montant",
  "Prime de Noël (max (RSA,ASS du conjoint))",
  "PA - Forfait logement",
  "PA - Base ressources",
  "PA - Bonus d'activité théorique",
  "PA - Bonus d'activité servi",
  "PA - Montant",
  "Total des minima sociaux et PA",
  "Total des minima sociaux et PA, y compris le chèque énergie",
  "Allocation de rentrée scolaire - Montant",
  "Total des prestations familiales",
  "Revenu imposable (RFR)",
  "Revenu imposable par part fiscale",
  "Impôt par part fiscale",
  "Impôt total",
  "Revenu imposable par part fiscale (sans demi-part supplémentaire)",
  "Impôt par part fiscale (sans demi-part supplémentaire)",
  "Impôt total (sans demi-part supplémentaire)",
  "Avantage lié au QF",
  ...
  "Avantage lié au QC",
  "Montant de TH avant dégrèvement",
  "TH - Montant",
  "Total des salaires nets",
  "Total des revenus hors salaires",
  "Total des prestations",
  "Total des impôts",
  "Revenu disponible",
  "Niveau de vie",
  "Taux d'imposition marginal implicite (TIMI) sur le revenu net",
  "Effet marginal sur le revenu disponible (1-TIMI)",
  "Taux d'imposition marginal implicite (sur le superbrut)",
  "Décile de niv. de vie",
  "Droit à la CSS gratuite",
  "Droit à la CSS payante",
  "Chèque énergie - Montant",
  "Revenu disponible y compris le chèque énergie"
)
...
labels19 <- c(
  ...
  "Plafond CF majoré",
  "Complément familial - Montant",
  "Allocation de soutien familial - Montant",
  "Plafond AB taux partiel",
  "Plafond AB taux plein",
  "AB (Paje) - Montant",
  "AAH - Base ressources (PR)",
...
labels17 <- c(
  ...
  "PA - Montant",
  "Total des minima sociaux et PA",
  "Total des minima sociaux et PA, y compris les TPN (électricité)",
  "Allocation de rentrée scolaire - Montant",
  "Total des prestations familiales",
  "Revenu imposable (RFR)",
  "Revenu imposable par part fiscale",
...
labels16 <- c(
  ...
  "Impôt par part fiscale (sans demi-part suppl)",
  "Impôt total (sans demi-part suppl)",
  "Avantage lié au QF",
  "Impôt après plafonnement QF",
  "Décote",
  "Impôt sur le revenu - Montant",
